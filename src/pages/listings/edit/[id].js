                ...
                <div className="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                  <div className="sm:col-span-2">
                    ...
                    <input
                      ...
                      required
                      className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-600 sm:text-sm"
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
                    {existingMedia.map((media) => (
                      <div key={media.id} className={`relative group border rounded-md overflow-hidden ${media.is_primary || media.id === primaryMediaId ? 'ring-2 ring-red-600' : ''}`}>
                        <img
                        ...
                        <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                          <button
                            ...
                            className="p-1 bg-red-600 text-white rounded-full mx-1"
                  ...
                  <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                    <div className="space-y-1 text-center">
                      ...
                      <div className="flex text-sm text-gray-600">
                        <label htmlFor="file-upload" className="relative cursor-pointer bg-white rounded-md font-medium text-red-600 hover:text-red-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-red-600">
                ...
                {uploadedMedia.length > 0 && (
                  <div className="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
                    {uploadedMedia.map((file, index) => (
                      <div key={index} className={`relative group border rounded-md overflow-hidden ${index === newPrimaryMediaIndex ? 'ring-2 ring-red-600' : ''}`}>
                        <img
                  ...
                  <div>
                    ...
                    <div className="mt-1 relative rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className="mt-1 block w-full pl-7 border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-600 sm:text-sm"
                        placeholder="0.00"
                      />
                    </div>
                  </div>
              ...
              <div className="pt-5">
                <div className="flex justify-end">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-50"
                  >
